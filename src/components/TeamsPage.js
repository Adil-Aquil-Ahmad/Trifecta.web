...
function TeamsPage() {
  ...
  const organisingTeam = [
    ...
    { name: 'Abhimanyu', post: 'Multimedia Team', image: '/PICS/Teams/Abhi.jpeg', linkedin: null },
    ...
    { name: 'Saanvi', post: 'Hospitality Team', image: '/PICS/Teams/Saanvi.jpg', linkedin: null },
  ]
